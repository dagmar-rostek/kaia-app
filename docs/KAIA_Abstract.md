...
**Verfasserin:** Dagmar Rostek  
**Hochschule:** SRH Fernhochschule Riedlingen  
**Studiengang:** M.Sc. Data Science & Analytics  
**Betreuer:** Prof. Dr. Thomas Ekert, Prof. Dr. Christian Prinz  
**Abgabe:** 1. September 2026

---

Diese Arbeit dokumentiert die Entwicklung und explorative Evaluation von KAIA (Kinetic AI Agent), einem empathischen KI-Lernbegleiter für den deutschsprachigen Hochschulkontext. KAIA adressiert den **Knowing-Doing Gap** (Pfeffer & Sutton, 2000): die Lücke zwischen vorhandenem Wissen und konkretem Alltagshandeln. Das System setzt sokratische Gesprächsführung ein, um Implementation Intentions (Gollwitzer, 1999) zu aktivieren, und personalisiert seine Adaptionslogik auf Basis eines kognitiv-affektiven Zustandsmodells (neuroadaptiver Modus), gespeist aus der Gesprächshistorie und einem MSLQ-basierten Nutzerprofil.
...
**Schlagworte:** KI-Lernbegleitung, Knowing-Doing Gap, sokratische Gesprächsführung, Selbstwirksamkeitserwartung, Large Language Models

*Keywords: AI learning companion, knowing-doing gap, Socratic dialogue, self-efficacy, large language models*
