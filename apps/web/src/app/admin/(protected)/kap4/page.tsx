...
function get(): string {
  return readDoc("KAIA_Kap4_Methodisches_Vorgehen.md", "# Kapitel 4 — Methodisches Vorgehen\n\nInhalt folgt.")
}
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto space-y-6">
      <div className="space-y-1">
        <h1 className="text-2xl font-bold tracking-tight">Kapitel 4 — Technische Implementierung</h1>
        <p className="text-muted-foreground text-sm">Draft v0.2 · Chat/LLM-Abschnitte folgen Juli 2026</p>
      </div>
