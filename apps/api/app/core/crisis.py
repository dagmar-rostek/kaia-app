...
_RAW_PATTERNS = [
    ...
    r"nicht\s+mehr\s+leben\s+(wollen|möchten|will|möchte)",
    r"nicht\s+mehr\s+da\s+sein\s+(wollen|möchten|will|möchte)",
    r"leben\s+(be)?enden",
    r"sterben\s+wollen",
    r"will\s+sterben",
    ...
    r"keinen\s+ausweg\s+(mehr\s+)?(sehen|sehe|haben|habe)",
