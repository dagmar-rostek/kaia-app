...
function get(): string {
  return readDoc("KAIA_Kap4_Studiendesign.md", "# Kapitel 6 — Studiendesign & Pilotstudie\n\nInhalt folgt.")
}
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto space-y-6">
      <div className="space-y-1">
        <h1 className="text-2xl font-bold tracking-tight">Kapitel 6 — Pilotstudie & Evaluation</h1>
        <p className="text-muted-foreground text-sm">Draft v0.3 · Ergebnisse folgen August 2026</p>
      </div>
