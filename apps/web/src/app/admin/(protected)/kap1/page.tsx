...
function get(): string {
  return readDoc("KAIA_Kap1_Einleitung.md", "# Kapitel 1 — Einleitung\n\nInhalt folgt.")
}
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto space-y-6">
      <div className="space-y-1">
        <h1 className="text-2xl font-bold tracking-tight">Kapitel 1 — Einleitung</h1>
        <p className="text-muted-foreground text-sm">Platzhalter — wird zuletzt geschrieben (August 2026)</p>
      </div>
