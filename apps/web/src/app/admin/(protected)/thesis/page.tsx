...
export default function ThesisPage() {
  const chapters = {
    ...
    kap2: prep("THEORIE.md",                   "# Kapitel 2 — Theoretischer Hintergrund\n\nInhalt folgt."),
    kap3: prep("KAIA_Kap3_Rahmenwerk.md",      "# Kapitel 3 — Konzeptionelles Rahmenwerk\n\nInhalt folgt."),
    kap4: prep("KAIA_Kap4_Implementierung.md", "# Kapitel 4 — Technische Implementierung\n\nInhalt folgt."),
    kap5: prep("KAIA_Kap5_LLM_Eval.md",        "# Kapitel 5 — LLM-Evaluationsbericht\n\nInhalt folgt."),
    kap6: prep("KAIA_Kap6_Pilotstudie.md",     "# Kapitel 6 — Pilotstudie & Evaluation\n\nInhalt folgt."),
  }
