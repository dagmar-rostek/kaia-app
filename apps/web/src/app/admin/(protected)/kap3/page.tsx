  ...
  return (
    <div className="p-8 max-w-4xl mx-auto space-y-6">
      <div className="space-y-1">
        <h1 className="text-2xl font-bold tracking-tight">Kapitel 3 — Konzeptionelles Rahmenwerk</h1>
        <p className="text-muted-foreground text-sm">Draft v0.3 · Architect · AI Engineer</p>
      </div>
